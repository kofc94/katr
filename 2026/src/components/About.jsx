    ...
    <section id="about" className="section">
      <div className="section-header">
        ...
        <p className="section-desc">
          Join us at Heritage Hall (177 Bedford St, Lexington) for an exciting community gala! Event guests jockey wooden horses around the track while attendees place bets and cheer on their favorites.
        </p>
      </div>
      ...
      <div className="features-grid">
        <div className="feature-card">
          ...
          <h3 className="feature-title">5 Action Races</h3>
          <p className="feature-desc">
            5 exciting races featuring wooden horses jockeyed live by event guests around the track! Place your bets and win cash & raffle prizes.
          </p>
        </div>
